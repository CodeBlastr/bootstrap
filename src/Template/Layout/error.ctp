...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/GoBigBooty/robot-svg/css/page.css">
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:700,300' rel='stylesheet' type='text/css'>

    <script src="/GoBigBooty/robot-svg/js/tweenmax.min.js" type="text/javascript"></script>
    <script src="/GoBigBooty/robot-svg/js/brokebot.js" type="text/javascript"></script>
    <script src="/GoBigBooty/robot-svg/js/snap.svg-min.js" type="text/javascript"></script>
    <script>
        var isHeadless = true;
    </script>
</head>
...
<body>
    <p>Move this to the Bootstrap Theme!!!!</p>
    <div>
